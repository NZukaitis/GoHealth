...
function Fitness() {
    ...
    const ExpandMore = styled((props: ExpandMoreProps) => {
        ...
        return <Typography variant="body2" fontWeight="bold" color="text.secondary"> View fitness <IconButton {...other} /> </Typography>;
    })(({ theme, expand }) => ({
                            ...
                            <Card variant="outlined" style={cardStyle}>
                                ...
                                <CardContent>
                                    <Typography variant="body2" color="text.secondary">
                                        General overview of the fitness
                                    </Typography>
                                </CardContent>
                                ...
                                <Collapse in={expanded1} timeout="auto" unmountOnExit>
                                    <CardContent>
                                        <Typography paragraph>Description of the fitness</Typography>
